...
public class GildedRoseTest
{
    ...
    [Test]
    public void Conjured_Decreasing_Test()
    {
        var items = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = 3, Quality = 49 } };
        GildedRose app = new GildedRose(items);
        app.UpdateQuality();
    ...
    [Test]
    public void Conjured_Fast_Decreasing_Test()
    {
        var items = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = -2, Quality = 49 } };
        GildedRose app = new GildedRose(items);
        app.UpdateQuality();
        Assert.That(items[0].Quality, Is.EqualTo(45));
    }

    [Test]
    public void Conjured_Decreasing_SellIn_Test()
    {
        var items = new List<Item> { new Item { Name = "Conjured Mana Cake", SellIn = 1, Quality = 49 } };
        GildedRose app = new GildedRose(items);
        app.UpdateQuality();
        Assert.That(items[0].SellIn, Is.EqualTo(0));
    }
